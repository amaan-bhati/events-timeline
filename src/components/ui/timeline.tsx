...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 font-helvetica-bold">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4">
            ...
            <a href="https://twitter.com/front_end_er" className="text-blue-500 hover:text-blue-400 text-xs sm:text-sm md:text-base">Twitter</a>
          </div>
        </div>
      </div>
